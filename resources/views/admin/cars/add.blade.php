...
@section('content')
    ...
    <form action="/admin/cars" method="POST">
        ...
        <input id="year" class="form-control mb-3" type="number" min="2000" max="2023" name="year">

        <label for="price">Price</label>
        <input id="price" class="form-control mb-3" type="number" min="30000" max="100000" name="price">
